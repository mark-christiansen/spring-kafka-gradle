...
public class AccountContactTopologyBuilder extends AbstractTopologyBuilder {
    ...
    private final com.mycompany.kafka.streams.Serdes serdes;
    ...
    public AccountContactTopologyBuilder(@Qualifier("applicationProperties") Properties appProps,
                                         Producer<Long, GenericRecord> errorHandler,
                                         com.mycompany.kafka.streams.Serdes serdes) {

        this.accountContactInputTopic = (String) appProps.get(ACCOUNT_CONTACT_TOPIC);
        this.contactInputTopic = (String) appProps.get(CONTACT_TOPIC);
        this.contactRoleInputTopic = (String) appProps.get(CONTACT_ROLE_TOPIC);
        this.outputTopic = (String) appProps.get(OUTPUT_TOPIC);
        this.failureOutputTopic = (String) appProps.get(ERROR_TOPIC);
        this.errorHandler = errorHandler;
        this.serdes = serdes;
        boolean inMemoryStateStores = Boolean.parseBoolean((String) appProps.get(IN_MEMORY_STATE_STORES));
