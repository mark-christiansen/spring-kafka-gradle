...
public class ContactAddressTopologyBuilder extends AbstractTopologyBuilder {
    ...
    public ContactAddressTopologyBuilder(@Qualifier("applicationProperties") Properties appProps,
                                         Producer<Long, GenericRecord> errorHandler,
                                         com.mycompany.kafka.streams.Serdes serdes) {

        this.contactAddressInputTopic = (String) appProps.get(CONTACT_ADDRESS_TOPIC);
        this.countryInputTopic = (String) appProps.get(COUNTRY_TOPIC);
        this.stateInputTopic = (String) appProps.get(STATE_TOPIC);
